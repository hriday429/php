	...
	<?php
		...
		if ( isset($_POST['register']) ){
			...
			if( $password != $cpassword ){
				...
				$query = "INSERT INTO read_bd (username, password, firstname, lastname, email, phone, address, join_date) VALUES ('$username', '$hassedPassword', '$fname', '$lname', '$email', '$phone', '$address', now())";
