...
<html lang="en">
  		...
  		<div class="container">
            ...
            <?php
                if ( isset($_GET['update']) ){
                  ...
                  $myQuery = "SELECT * FROM read_bd WHERE id = '$updateStudent' ";
  ...
  <?php
    ...
    if ( isset($_POST['updateStudent']) ){
      ...
      $query = "UPDATE read_bd SET username='$username', firstname='$fname', lastname='$lname', email='$email', phone='$phone', address='$address' WHERE id = '$updateStudent' ";
